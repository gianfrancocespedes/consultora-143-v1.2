		...
		<>
			...
			<Dialog open={isOpen} onClose={(val) => setIsOpen(val)} static={true} initialFocus={null}>
				<DialogPanel>
					...
					<div className="mx-auto max-w-xs mt-6 space-y-4">
						{/* <label htmlFor="distance" className="text-tremor-default text-tremor-content dark:text-dark-tremor-content">
							Select distance
						</label> */}
                        <TextInput placeholder="Contraseña actual" type="password" />
                        <TextInput placeholder="Nueva contraseña" type="password" />
                        <TextInput placeholder="Repita nueva contraseña" type="password" />
					</div>
